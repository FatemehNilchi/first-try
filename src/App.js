...
export default function App() {
  ...
  return (
    <div className="container">
      <Product {...allProducts[0]}><button>OFF (50%)</button></Product>
      <Product {...allProducts[1]}><h2>OFF (30%)</h2></Product>
      <Product {...allProducts[2]}></Product>
      <Product {...allProducts[3]}></Product>
    </div>
  );
}
